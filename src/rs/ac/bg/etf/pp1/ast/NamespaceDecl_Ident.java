...
public class NamespaceDecl_Ident extends NamespaceDecl {

    private NamespaceName NamespaceName;
    private DeclList DeclList;
    private MethodDeclList MethodDeclList;

    public NamespaceDecl_Ident (NamespaceName NamespaceName, DeclList DeclList, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NamespaceDecl_Ident(\n");
