...
public class LocalVarDeclList_List extends LocalVarDeclList {

    private LocalVarDeclList LocalVarDeclList;
    private VarDeclList VarDeclList;

    public LocalVarDeclList_List (LocalVarDeclList LocalVarDeclList, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("LocalVarDeclList_List(\n");
